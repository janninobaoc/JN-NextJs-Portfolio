        ...
        .map((item) => {
          ...
          if (section) {
            return {
              ...
              offset: (section as HTMLElement).offsetTop - 100,
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center gap-2">
            <a
              ...
              className={`flex items-center text-xl font-bold bg-clip-text text-transparent ${
                isDark
                  ? "bg-gradient-to-r from-white via-blue-100 to-purple-200"
                  : "bg-gradient-to-r from-black via-gray-600 to-gray-800"
              }`}
            >
              <img src="/img/profile.png" alt="Logo" className="w-6 h-6 rounded-full" />
              JN
            </a>
            <ThemeToggle />
          </div>
