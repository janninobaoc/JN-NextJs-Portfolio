...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const formSubmitUrl = 'https://formsubmit.co/nino06jan@gmail.com';
    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%]">
      ...
      >
        <div className="container px-[1%] grid grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-3 py-3 md:p-10 md:py-8 shadow-2xl transition-all duration-500 hover:shadow-[#6366f1]/10">
            <Comments />
          </div>
        </div>
      </div>
